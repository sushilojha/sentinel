(function () {
	...
	TwtrGlobe.init = function () {
		...
		renderer.setClearColor(0xFAFADD, 0.0);
	...
	TwtrGlobe.onTweet = function (tweet) {
		...
		var randomLat =  getRandomInRange(-180, 180, 3);
		var randomLong = getRandomInRange(-180, 180, 3);
		
		if (tweet.coordinates != null) {
			randomLat = tweet.coordinates.coordinates[1];
			randomLong = tweet.coordinates.coordinates[0];
		}
